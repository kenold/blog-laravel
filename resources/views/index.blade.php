            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $featured_post->featured }}" alt="{{ $featured_post->title }}">
                            <div class="overlay"></div>
                            <a href="{{ $featured_post->featured }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="{{ route('post.single', ['slug' => $featured_post->slug])}}" class="link-post">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="{{ route('post.single', ['slug' => $featured_post->slug]) }}">{{ $featured_post->title }}</a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="{{ route('category.show', ['id' => $featured_post->category->id])}}">{{ $featured_post->category->name }}</a>
                                        </span>
            ...
            <div class="container">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $news->name }}</h4>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach($news->posts()->take(3)->get() as $post)
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $videos->name }}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
